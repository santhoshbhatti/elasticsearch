...
public class ElasticIndexerApplication {
	...
	public String hello() throws IOException {
		...
		return "Hello!!!!!!!" + (client != null) + response.toString();
	}
	...
	private  Pair parseMovieJson(String line) {
		...
		String metaData=CREATE_META_DATA.replace("<movie_id>", line.substring(0,line.indexOf(",")));
		
		StringBuilder builder = new StringBuilder("{");
		builder.append("\"id\":\"").append(line.substring(0,line.indexOf(","))).append("\",");
